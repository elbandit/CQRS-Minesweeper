...
namespace Columbo.Minesweeper.Specs.Core.Domain_Specs
{
    public class when_handling_a_reveal_a_tile_command : WithSubject<RevealTileHandler>
    {
        private Establish context = () =>
        {
            ...
            The<IGameCenter>().WhenToldTo(x => x.get_game_for(reveal_tile_command.player_id)).Return(game);
        };
        ...
        {
            The<IGameCenter>().WasToldTo(x => x.get_game_for(reveal_tile_command.player_id));
        };
